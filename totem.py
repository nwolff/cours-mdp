...
ANIMALS = [
    "abeille", "aigle", "âne", "araignée", "baleine", "biche", "cerf", "cigogne",
    "corbeau", "dauphin", "écureuil", "éléphant", "faucon", "gazelle", "girafe", "hibou",
    "hirondelle", "lion", "loutre", "lynx", "mésange", "ours", "panda", "panthère",
    "pélican", "raton", "renard", "requin", "salamandre", "tigre", "tortue", "zèbre",
]

# Invariant adjectives (same form in masculine / feminine) so they agree with
# any animal in the list without further inflection.
ADJECTIVES = [
    "agile", "aimable", "brave", "calme", "célèbre", "drôle", "écarlate", "fidèle",
    "fragile", "habile", "honnête", "humble", "intrépide", "jeune", "libre", "lyrique",
    "magnifique", "mince", "noble", "paisible", "propre", "rapide", "robuste", "rouge",
    "sage", "sauvage", "sincère", "solide", "sombre", "splendide", "tenace", "tranquille",
]
